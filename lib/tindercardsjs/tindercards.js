...
Tindercardsjs = (function () {
   ...
   * @class
   */
  exports.card = function (name, desc, imgpath) {
    ...
    this.tojQuery = function () {
      if (!jqo) {
        jqo = $('<div class="tc-card">').html('<div class="tc-card-img-cont"><img src="' + imgpath + '" class="tc-card-img"><div class="tc-card-body"><h2 class="tc-card-name">' + name + '</h2><span class="tc-card-desc">' + desc + '</span></div></div>');
      }
      return jqo;
    };
   ...
   * @memberof module:Tindercardsjs
   */
  exports.render = function (cards, $target) {
    var i,
      $card;
